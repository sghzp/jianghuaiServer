...
public class GetProjectIDByODBID {
    ...
    public static String ProjectTaskID(String DeviceID) {
        ...
        ResultSet rs = null;
        String sql = "SELECT a.Project_Task_ID FROM tb_project WHERE  a.PROJECT_TASK_ID = b.PROJECT_TASK_ID AND GETDATE()>STARTTIME AND TASK_STATE = 1 AND EQUIPMENTID='" + DeviceID + "';";
