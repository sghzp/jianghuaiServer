...
public class ProjectRoleID {
	...
	public static ConcurrentHashMap<String,String> ProjectRoleID(String projectTaskID) {
		String ROLE_ID = null;
		String VIN = null;
		...
		ResultSet rs = null;
		String sql = "SELECT a.ROLE_ID, c.VIN FROM tb_project a, tb_project_task b,tb_project_car c WHERE b.PROJECT_TASK_ID = '" + projectTaskID + "' AND a.PROJECT_ID = b.PROJECT_ID AND c.PROJECT_CAR_ID = b.PROJECT_CAR_ID";
		...
		try {
			...
			if(rs.next()){
				if(rs.getObject("ROLE_ID") != null) {
					...
					if(!"".equals(ROLE_ID) && !"".equals(VIN) && ROLE_ID != null && VIN != null){
